...
public class Crossword extends JPanel implements MouseListener, KeyListener {
    ...
    private static void createAndShowGUI(){
        ...
        frame.add(new Crossword(), BorderLayout.CENTER);

        JPanel textpanel = new JPanel();
        textpanel.setLayout(new BorderLayout());
        textpanel.add(new JLabel("Horizontal"), BorderLayout.SOUTH);
        textpanel.add(new JLabel("Vertical"), BorderLayout.NORTH);
